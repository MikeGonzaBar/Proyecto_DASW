...
router.get('/',Val.validarToken,asyncHandler(Val.obtenerMaterias),asyncHandler(async (req,res)=>{
    
    res.status(200).send(req.body.materias);

}))

router.get('/:materia',asyncHandler(async (req,res)=>{
...
router.put('/',Val.validarToken,asyncHandler(async(req,res)=>{
